...
public class AccessorTest {
	...
	public void testGetField() throws Exception {
		...
		assertEquals(Integer.valueOf(4),
				(Integer) Accessor.getField(ForTests.class, "aStaticPrimitiveField"));
		...
		//
		assertEquals(Integer.valueOf(3), (Integer) Accessor.getField(ForTests.class,
				new ForTestsB(), "aPrimitiveField"));

		// testcase 7
		//
		// non-static not overwritten field 
		//
		assertEquals(Integer.valueOf(33), (Integer) Accessor
				.getField(ForTestsB.class, new ForTestsB(), "aPrimitiveField"));

		// testcase 8
		//
		// static field 
		//
		assertEquals(Integer.valueOf(4), (Integer) Accessor.getField(ForTests.class,
				null, "aStaticPrimitiveField"));

		// testcase 9
		//
		// static field 
		//
		assertEquals(Integer.valueOf(43), (Integer) Accessor
				.getField(ForTestsB.class, null, "aStaticPrimitiveField"));
		...
		//
		try {
			Accessor.getField(ForTests.class, null, "aPrimitiveField");
		} catch (IllegalArgumentException e) {
			assertEquals(
					"The specified field 'aPrimitiveField' should " + "be static. ",
					e.getMessage());
		} // end of try-catch
	...
	public void testSetField() throws Exception {
		...
		// static field 
		//
		Accessor.setField(ForTests.class, "aStaticPrimitiveField",
				Integer.valueOf(40));
		...
		//
		try {
			Accessor.setField((Class<?>) null, "aStaticPrimitiveField",
					Integer.valueOf(-1));
		} catch (IllegalArgumentException e) {
			assertEquals("Specified null-class. ", e.getMessage());
		} // end of try-catch
		...
		//
		try {
			Accessor.setField(null, null, "aStaticPrimitiveField",
					Integer.valueOf(-1));
		} catch (IllegalArgumentException e) {
			assertEquals("Specified null-class. ", e.getMessage());
		} // end of try-catch
		...
		//
		obj = new ForTestsB();
		Accessor.setField(ForTests.class, obj, "aPrimitiveField",
				Integer.valueOf(30));
		assertEquals(Integer.valueOf(30),
				(Integer) Accessor.getField(ForTests.class, obj, "aPrimitiveField"));
		...
		//
		obj = new ForTestsB();
		Accessor.setField(ForTestsB.class, obj, "aPrimitiveField",
				Integer.valueOf(330));
		assertEquals(Integer.valueOf(330),
				(Integer) Accessor.getField(ForTestsB.class, obj, "aPrimitiveField"));

		// testcase 8
		//
		// static field 
		//
		Accessor.setField(ForTests.class, null, "aStaticPrimitiveField",
				Integer.valueOf(40));
		assertEquals(Integer.valueOf(40), (Integer) Accessor
				.getField(ForTests.class, null, "aStaticPrimitiveField"));
		...
		// static field 
		//
		Accessor.setField(ForTestsB.class, null, "aStaticPrimitiveField",
				Integer.valueOf(430));
		assertEquals(Integer.valueOf(430), (Integer) Accessor
				.getField(ForTestsB.class, null, "aStaticPrimitiveField"));
		...
		//
		try {
			Accessor.setField(Integer.class, null, "aNonExistingField",
					Integer.valueOf(-1));
		} catch (NoSuchFieldException e) {
			assertEquals("aNonExistingField", e.getMessage());
		} // end of try-catch
		...
		//
		try {
			Accessor.setField(ForTests.class, new ForTests(), "aStaticPrimitiveField",
					Integer.valueOf(-1));
		} catch (IllegalArgumentException e) {
			assertEquals("The specified field 'aStaticPrimitiveField' should "
					+ "not be static. ", e.getMessage());
		...
		//
		try {
			Accessor.setField(ForTests.class, null, "aPrimitiveField",
					Integer.valueOf(-1));
		} catch (IllegalArgumentException e) {
			assertEquals(
					"The specified field 'aPrimitiveField' should " + "be static. ",
		...
		//
		try {
			Accessor.setField(ForTests.class, "aFinalField", Integer.valueOf(-1));
		} catch (IllegalArgumentException e) {
			assertEquals(
					"Field 'aFinalField' in class '" + ForTests.class.getName()
		...
		//
		try {
			Accessor.setField(ForTests.class, "aStaticPrimitiveField", null);
		} catch (IllegalArgumentException e) {
			assertEquals(
					"Tried to assign null-value " + "to field 'aStaticPrimitiveField'"
							+ " in class '" + ForTests.class.getName()
							+ "' although its type '" + Integer.TYPE + "' is primitive. ",
					e.getMessage());
		} // end of try-catch
	...
	public void testCreate() throws Exception {
		...
		// default constructor 
		//
		Accessor.create(ForTests.class, new Class[] {}, new Object[] {});
	} // testCreate 
	...
	public void testInvoke() throws Exception {
		...
		//
		//
		result = ((Integer) Accessor.invoke(new ForTestsB(), "privateMethod",
		...
		//
		//
		result = ((Integer) Accessor.invoke(new ForTests(), "privateMethod",
				Integer.valueOf(2))).intValue();
		...
		//
		//
		result = ((Integer) Accessor.invoke(new ForTestsB(), "protectedMethod",
				Integer.valueOf(2))).intValue();
		...
		//
		//
		result = ((Integer) Accessor.invoke(new ForTests(), "protectedMethod",
				Integer.valueOf(2))).intValue();
		...
		result = ((Integer) Accessor.invokeStatic(ForTests.class,
				"privateStaticMethod", Integer.valueOf(2))).intValue();
	...
	public void testGetInnerClass() {
		...
		try {
			...
			assertEquals(
					"Class '" + AccessorTest.class.getName()
		...
		assertEquals(ForTests.class,
				Accessor.getInnerClass(AccessorTest.class, "ForTests"));
	} // testGetInnerClass 
